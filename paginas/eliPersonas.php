...
<body>
  ...
  <table width="383" border="1" cellspacing="1" cellpadding="1">
    ...
    <tr>
      <td>Nombres</td>
      <td><input name="persona[nombres]" type="text" id="nombres" readonly="yes" size="45" value="<?php echo $persona->getNombre();?>" /></td>
    </tr>
    <tr>
      <td>Apellidos</td>
    ...
    <tr>
      <td>Telefono 1</td>
      <td><input name="persona[telefono1]" type="text" id="telefono1" readonly="yes" value="<?php echo $persona->getTelefono1();?>" /></td>
    </tr>
    <tr>
      <td>Telefono 2</td>
      <td><input name="persona[telefono2]" type="text" id="telefono2" readonly="yes" value="<?php echo $persona->getTelefono2();?>" /></td>
    </tr>
    <tr>
      <td>Email</td>
      <td><input name="persona[email]" type="text" id="email" size="45" readonly="yes" value="<?php echo $persona->getEmail();?>" /></td>
    </tr>
    <tr>
      <td>Direccion</td>
      <td><input name="persona[direccion]" type="text" id="direccion" readonly="yes" size="45" value="<?php echo $persona->getDireccion();?>" /></td>
    </tr>
    <tr>
